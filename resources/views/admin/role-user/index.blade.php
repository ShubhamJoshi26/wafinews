        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{ route('auth.admin.role-users.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('auth.admin.role-users.edit', $admin->id) }}"
                                        class="btn btn-primary"><i class="fas fa-edit"></i></a>

                                    <a href="{{ route('auth.admin.role-users.destroy', $admin->id) }}"

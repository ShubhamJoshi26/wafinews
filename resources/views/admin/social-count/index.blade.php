        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{ route('/news/auth/admin/social-count.create') }}" class="btn btn-primary">
                                        ...
                                        <tbody>
                                            @foreach ($socialCounts as $socialCount)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('/news/auth/admin/social-count.edit', $socialCount->id) }}"
                                                            class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                                        <a href="{{ route('/news/auth/admin/social-count.destroy', $socialCount->id) }}"

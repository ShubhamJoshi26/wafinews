                                        ...
                                        <tbody>
                                            @foreach ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('/news/auth/admin/category.edit', $category->id) }}" class="btn btn-primary"><i
                                                                class="fas fa-edit"></i></a>
                                                        <a href="{{ route('/news/auth/admin/category.destroy', $category->id) }}" class="btn btn-danger delete-item"><i

                ...
                <div class="tab-content tab-bordered" id="myTab3Content">
                    @foreach ($languages as $language)
                        ...
                        <div class="tab-pane fade show {{ $loop->index === 0 ? 'active' : '' }}"
                            ...
                            <div class="card-body">
                                <form action="{{ route('/news/auth/admin/footer-grid-three-title') }}" method="POST">
                                    @csrf
        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{ route('/news/auth/admin/footer-grid-three.create') }}" class="btn btn-primary">
                                        ...
                                        <tbody>
                                            @foreach ($footer as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('/news/auth/admin/footer-grid-three.edit', $item->id) }}" class="btn btn-primary"><i
                                                                class="fas fa-edit"></i></a>
                                                        <a href="{{ route('/news/auth/admin/footer-grid-three.destroy', $item->id) }}" class="btn btn-danger delete-item"><i

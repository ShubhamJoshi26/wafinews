                        ...
                        <div class="tab-pane fade show {{ $loop->index === 0 ? 'active' : '' }}"
                            ...
                            <div>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <form method="POST" action="{{ route('/news/auth/admin/extract-localize-string') }}">
                                                @csrf
                                            ...
                                            <form class="translate-from" method="POST"
                                                action="{{ route('/news/auth/admin/translate-string') }}">
                                                <input type="hidden" name="language_code" value="{{ $language->lang }}">
                                                <input type="hidden" name="file_name" value="frontend">
                                                <button  type="submit"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('/news/auth/admin/update-lang-string') }}" method="POST">
                        @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.translate-from').on('submit', function(e) {
                ...
                $.ajax({
                    method: 'POST',
                    url: "{{ route('/news/auth/admin/translate-string') }}",
                    data: formData,
                    beforeSend: function(){

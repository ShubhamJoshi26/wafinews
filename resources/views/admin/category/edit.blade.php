...
@section('content')
    <section class="section">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('/news/auth/admin/category.update', $category->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input name="metatitle" value="{{ $category->metatitle }}" type="text" class="form-control" id="metatitle">
                        @error('metatitle')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input name="metakeywords" value="{{ $category->metakeywords }}" type="text" class="form-control" id="metakeywords">
                        @error('metakeywords')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input name="metadescription" value="{{ $category->metadescription }}" type="text" class="form-control" id="metadescription">

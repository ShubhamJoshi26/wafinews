          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content clearfix">
              ...
              <div class="modal-body pop-body">
                ...
                <form action="{{route('enquiry')}}" method="POST" id="enquiryForm">
                  @csrf
                ...
                <button class="btn btn-primary solid blank" onclick="submitEnquiryForm()">Submit Now</button>
              </div>
            </div>
          </div>
        </div>
    ...
    $.ajax({
      ...
      success:function(res)
      {
         if(res['status']=='error')
         {
            ...
            if(blankFields!='')
            {
              Swal.fire({
                icon: "error",
                title: "Oops...",
                text: blankFields+" these fields can't be empty",
              });
            }
         }
         else
         {
          Swal.fire({
            title: "Done",
            text: "Enquiry recieved successfully!",
            icon: "success"
          });
          $('.modal').modal('hide');
         }

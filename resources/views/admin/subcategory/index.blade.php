        ...
        <div class="card card-primary">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{ route('/news/auth/admin/subcategory.create') }}" class="btn btn-primary">
                                ...
                                <tbody>
                                    @foreach ($subcategories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('/news/auth/admin/subcategory.edit', $category->id) }}"
                                                    class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                                <a href="{{ route('/news/auth/admin/subcategory.destroy', $category->id) }}"
